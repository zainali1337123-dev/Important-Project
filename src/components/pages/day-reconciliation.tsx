      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <QuickNav
          ...
          items={[
            ...
            { id: "section-income", label: "Income Summary", icon: TrendingUp, iconColor: "text-[#087F83]" },
            { id: "section-breakdown", label: "Credit vs Cash", icon: CreditCard },
            { id: "section-expenses", label: "Expenses Summary", icon: TrendingDown, iconColor: "text-[#C28A24]" },
            { id: "section-net", label: "Net Cash Position", icon: Scale },
            { id: "section-detail", label: "Records Detail", icon: FileText, iconColor: "text-[#087F83]" },
          ]}
        />
